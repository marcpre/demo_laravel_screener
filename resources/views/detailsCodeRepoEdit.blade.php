                        ...
                        <div class="tabbable" id="tabs-305570">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="panel-495769">
                                    ...
                                    <!-- Form -->
                                    <form action="{{ route('instrument.updateCodeRepoDetails', [$instrumentUnderEdit->id]) }}" method='POST' class="repeater" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <label>Link</label>
                                        <div data-repeater-list="codeRepo">
                                            <div data-repeater-item>

                                                <input type="text" name="codeRepoLink" value='' />
